...
const contentVaritions = {
  ...
  "gradient": (props: IContent) => {
    return (
      <div id={props.id} className="items-center w-full justify-center flex  py-20 bg-gradient-to-r from-rose-200 to-violet-400 dark:from-rose-400 dark:to-violet-600 rounded">
        <div className="max-w-128 w-11/12 lg:px-0 px-5 flex flex-col gap-20">
          {props.children}
        </div>
      </div>
